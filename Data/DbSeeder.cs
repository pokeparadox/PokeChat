...
public static class DbSeeder
{
    ...
    private static void SeedBotResponses(PokeChatDbContext context, string now)
    {
        ...
        var responses = new (string Category, string ResponseText)[]
        {
            ...
            ("proactive_preference", "You like {0}? I love that too! What else?"),
            ("proactive_preference", "I remember you {2} {0}. Tell me more about that!"),
            ...
            ("proactive_belief", "You know about {0}? I'd love to learn more."),
            ("proactive_belief", "What got you interested in {0}?"),
            ("proactive_personal", "You said you're {0}. What's that like?"),
            ("proactive_personal", "Being {0} sounds interesting. Tell me more!"),
            ("proactive_personal", "How long have you been {0}?"),
            ("proactive_general_fact", "You mentioned {0} {1} {2}. What do you think about it?"),
            ("proactive_general_fact", "So {0} {1} {2}. That's interesting! Tell me more."),
