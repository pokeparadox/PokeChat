...
public static class DbSeeder
{
    ...
    private static void SeedBotResponses(PokeChatDbContext context, string now)
    {
        ...
        var responses = new (string Category, string ResponseText)[]
        {
            ...
            ("word_classify_default", "Thanks! I've learned the word '{0}'. Is it a person, place, thing, verb, adjective, or noun?"),
            ...
            ("word_classify_dont_know", "No problem, I'll keep it as unknown for now."),
            ("word_classify_dont_know", "That's okay — I'll figure out the type later."),
            ("word_classify_llm_result", "I think '{0}' is a {1}."),
            ("word_classify_llm_result", "I'd guess '{0}' is a {1}."),
            ...
            ("llm_unavailable", "My AI isn't responding right now. Try again in a moment, or ask me something else!"),
            ("llm_unavailable", "I can't reach my AI at the moment. Try again shortly, or let's chat without it!"),
            ...
            ("reminder_created", "Sure thing! I'll remind you to {0} at {1}."),
