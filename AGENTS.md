...
- **Run log analysis during cleanup:** After completing a phase, scan `Api/logs/*.log` for response abnormalities. Read each log file and inspect every `### Bot` response for known bad patterns:
